    ...
    class SystemReportCommand: Command
    {
        ...
        public override void Execute(string[] commandArgs)
        {
            ...
            IEnumerable<IStarship> intactShips = this.GameEngine.Starships
                .Where(s => s.Health > 0 && s.Location.Name==locationName)
            ...
            IEnumerable<IStarship> destroyedShips = this.GameEngine.Starships.Where(s => s.Health <= 0 && s.Location.Name == locationName).ToList();
